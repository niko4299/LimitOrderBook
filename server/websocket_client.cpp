...
WebSocketClient::WebSocketClient(net::io_context& ioc, ssl::context& ctx,std::string host, std::string port, std::string subscribe_message): 
...
void WebSocketClient::run(){
        resolver_.async_resolve(
            ...
            beast::bind_front_handler(
                ...
                WebSocketClient::shared_from_this()));
}
...
void WebSocketClient::on_ssl_handshake(beast::error_code ec){
    ...
    if(ec) return on_fail(ec, "ssl_handshake");
...
void WebSocketClient::on_read(beast::error_code ec,
        std::size_t bytes_transferred){
        boost::ignore_unused(bytes_transferred);
